...
class LoadTransactionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.load_transaction.index', compact(['access_code', 'wallet_transaction']));
    }
    ...
    public function create()
    {
        ...
        return view('admin.load_transaction.create', compact(['load_types', 'wallet_transaction_types']));
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!$access_code){
            ...
            $wal = WalletTransaction::create([
                'access_provider_id' => auth()->user()->access_provider->id,
            ...
            $walData = [
                'trans_reference' => $wal->id.$date.auth()->user()->access_provider->id
            ];
            $wal->update($walData);
            ...
            return redirect()->route("load_transactions.index");
        }
    ...
    public function template($array){
        dd("this is working");
//        return view('admin.load_transaction.template', compact('array'));
    }
