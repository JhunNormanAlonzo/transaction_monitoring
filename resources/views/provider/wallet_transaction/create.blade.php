    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('provider_wallet_transactions.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input onkeyup="trans_amounts()" id="trans_amount" name="trans_amount" type="number" step="0.01"  class="form-control-sm form-control @error('trans_amount') is-invalid @enderror">
                                    @error('trans_amount')
                                    <span class="invalid-feedback">
                                            {{$message}}
                                        </span>
                            ...
                            <input name="access_provider_id" type="text" hidden value="{{auth()->user()->access_providers->id}}">
