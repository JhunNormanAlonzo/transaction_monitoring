    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('load_transactions.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input name="trans_cpnumber" id="trans_cpnumber" type="number" value="09123123123" class="form-control-sm form-control @error('trans_cpnumber') is-invalid @enderror">
