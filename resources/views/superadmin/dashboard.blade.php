                    ...
                    <div class="table-responsive">
                        <table class="table" id="table">
                            ...
                            @foreach($wallet_transactions as $wallet_transaction)
                                <tr>
                                    <td><img width="100" height="100" src="{{asset('storage/wallet_attachments/'.$wallet_transaction->wallet_transaction_attachment->attachment)}}" alt=""></td>
                                    <td>{{$wallet_transaction->wallet_transaction_type->trans_description}}</td>
                                    <td>{{$wallet_transaction->load_type_id ?? 'empty'}}</td>
                                    <td>{{$wallet_transaction->trans_date}}</td>
                                    <td>{{$wallet_transaction->trans_reference}}</td>
                                    <td>{{$wallet_transaction->trans_amount}}</td>
                                    <td>{{$wallet_transaction->approval_user_id ?? 'empty'}}</td>
                                    <td>{{$wallet_transaction->approved_at ?? 'empty'}}</td>
                                    <td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card sales-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Wallet Ballance <span>| Today</span></h5>
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <div class="card info-card revenue-card">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">E-Load Sent <span>| This Month</span></h5>
                            ...
                            <div class="card top-selling overflow-auto">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <table class="table table-borderless">
                                        <thead>
                                        <tr>
                                            <th scope="col">Product</x-th>
                                            <th scope="col">Price</x-th>
                                            <th scope="col">Sold</x-th>
                                            <th scope="col">Revenue</x-th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            <th scope="row"><a href="#"><img src="assets/img/product-2.jpg" alt=""></a></x-th>
                                        ...
                                        <tr>
                                            <th scope="row"><a href="#"><img src="assets/img/product-3.jpg" alt=""></a></x-th>
                                        ...
                                        <tr>
                                            <th scope="row"><a href="#"><img src="assets/img/product-4.jpg" alt=""></a></x-th>
                                        ...
                                        <tr>
                                            <th scope="row"><a href="#"><img src="assets/img/product-5.jpg" alt=""></a></x-th>
                            ...
                            <div class="activity">
                                ...
                                <div class="activity-item d-flex">
                                    ...
                                    <div class="activity-content">
                                        Von <a href="#" class="fw-bold text-dark">Jhunnie Boy</a> Recent Activity is here.
                                    </div>
