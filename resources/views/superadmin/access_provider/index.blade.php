        ...
        <div class="col-lg-12 offset-lg-0">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-sm btn-primary float-end" href="{{route('superadmin_access_providers.create')}}"><i class="bi bi-plus"></i> Create Access Provider</a>
                        ...
                        @if($providers->count() > 0)
                            @foreach($providers as $key => $provider)
                                <tr>
                                    ...
                                    <x-td>
                                        <a href="{{route('superadmin_access_providers.edit', [$provider->id])}}">
                                    ...
                                    <x-td>
                                        ...
                                        <form action="{{route('superadmin_access_providers.destroy', [$provider->id])}}" method="POST">
                                            @csrf
                                            @method('DELETE')
